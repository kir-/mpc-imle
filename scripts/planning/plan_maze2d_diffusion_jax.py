...
class Parser(utils.Parser):
    ...
    config: str = "config.maze2d_diffusion_jax"
...
print("[ utils/config ] Instantiated diffusion policy (JAX)")
...
plan_obs_np = None  # NumPy [B, H, obs_dim] for renderer
...
for t in range(env.max_episode_steps):
    ...
    # Next waypoint from predicted sequence
    if t < len(sequence) - 1:
